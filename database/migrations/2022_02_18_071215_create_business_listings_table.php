...
class CreateBusinessListingsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('business_listings', function (Blueprint $table) {
            ...
            $table->string('business_owner3_name', 192)->nullable();
            ...
            // $table->foreign('business_types_id')->references('id')->on('business_types')->onDelete('restrict');
            // $table->foreign('business_categories_id')->references('id')->on('business_categories')->onDelete('restrict');
        });
    }
